...
- **Run tab** — start your app's dev command in the background, watch its **logs live**, **Stop** it, and **open a browser preview** — a real runner beside the agent. The command is prefilled from the project's detected run command.
